...
1. **Fetch the source code**
     ...
     _R_ and _python_ source code for these examples can be downloaded as a [zip file](https://github.com/richardbeare/GeospatialStroke/archive/master.zip) and are also available to clone from the [github site](https://github.com/richardbeare/GeospatialStroke/)
...
1. Fetch the source code using the same procedures as for _R_ above.
