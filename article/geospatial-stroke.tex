...
relatively short time window following stroke. This has changed recently with the publication of the DAWN trial which has pushed the boundary to 24 hours for clot retrieval\cite{nogueira2018thrombectomy}. ECR treatment requires
...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=10cm]{map1.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=10cm]{map2.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=10cm]{map3.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=10cm]{map4.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
%\includegraphics[width=10cm]{map5.png}
\end{center}
