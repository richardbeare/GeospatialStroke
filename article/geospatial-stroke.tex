...
\def\Authors{Nicholas Tierney\,$^{1,*}$, Mark Padgham\,$^{2}$, Geoff Boeing\,$^{3}$, David Cooley\,$^{4}$, Michael Sumner\,$^{3}$, and Richard Beare\,$^{5,6}$}
...
$^{6}$Developmental Imaging, Murdoch Children's Research Institute, Melbourne, Victoria, Australia}
...
Community Survey (Bureau n.d.) \cite{us_census_bureau_acs} (a survey
...
shapefiles (Geography n.d.) \cite{us_census_tiger_line} of tract,
