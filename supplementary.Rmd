...
![anaconda prompt](python/screenshots/01-open-cmd-prompt.png)

changing directories to this `python` folder. This command depends on where you have extracted the zip file. For example, you may
use `cd GeospatialStroke\python` instead of `cd geo-demo\python`.

![changing directory](python/screenshots/02-change-directories.png)
...
![conda config and create](python/screenshots/03-create-env.png)

3. Activate virtual environment and install notebook kernel:
...
![conda activate and install](python/screenshots/04-activate-env-install-kernelspec.png)
...
![start jupyter notebook](python/screenshots/05-cd-notebooks-jupyter-lab.png)
