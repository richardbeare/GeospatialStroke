...
coordinate reference system is retained. The `right_join` uses postcodes in
...
"Postcode".
```{r basicDemog-mapview, eval = FALSE}
...
These postcode polygons as shown above can be viewed with `mapview` like this:
