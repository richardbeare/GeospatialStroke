...
Kingston <- st_union(st_sf(v[fromCoords$Destination=="KingstonHospital"], crs=4326))
Kingston <- st_intersection(Kingston, bounding_polygon)

Unknown <- st_union(st_sf(v[fromCoords$Destination=="Unknown"], crs=4326))
Unknown <- st_intersection(Unknown, bounding_polygon)

Casey <- st_union(st_sf(v[fromCoords$Destination=="CaseyHospital"], crs=4326))
Casey <- st_intersection(Casey, bounding_polygon)

Dandenong <- st_union(st_sf(v[fromCoords$Destination=="DandenongHospital"], crs=4326))
Dandenong <- st_intersection(Dandenong, bounding_polygon)

## This looks very strange:
plot(Dandenong, col=2)
plot(Casey, col=3, add=TRUE)
plot(Unknown, col=4, add=TRUE)
plot(Kingston, col=5, add=TRUE)
```
