...
inspected on a map with the following code.
```{r, eval = FALSE}
library(mapdeck)
set_token(Sys.getenv("MAPBOX_TOKEN"))
...
points were moved. In the present case, however, these repeats need to be
