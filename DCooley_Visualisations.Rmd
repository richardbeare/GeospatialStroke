...
And you can start to combine the services API with the mapping by quering Google's directions service, and plotting the results on a map. 
...
A **choropleth** is made by plotting coloured polygons on the map. In this example the polygons represent Statistical Areas (level 2) of melbourne, coloured according to the size of the region.  
